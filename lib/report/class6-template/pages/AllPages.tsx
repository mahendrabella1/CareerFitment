  ...
  return (
    <div style={PAGE_STYLE}>
      ...
      <div style={{ padding: '26pt', paddingBottom: '80pt', height: 'calc(297mm - 120pt)', overflow: 'hidden' }}>
        ...
        <p style={{ fontSize: '11pt', color: '#475569', lineHeight: 1.6, marginBottom: '16pt' }}>
          Your four-letter code shows how you naturally prefer to work, make decisions, and interact with others. Understanding these preferences helps you find careers where you'll thrive.
        </p>

        <div style={{ textAlign: 'center', marginTop: '16pt', marginBottom: '20pt' }}>
          <span style={{ fontSize: '28pt', fontWeight: 700, letterSpacing: '4pt', color: '#2f6bff', background: '#F0F4FF', padding: '10pt 24pt', borderRadius: '8pt' }}>
            {p.type}
          </span>
        </div>
        ...
        <div style={{ marginTop: '16pt', marginBottom: '20pt' }}>
          <DimensionSlider
            label="Social Energy"
            percentage={p.ei === 'E' ? 75 : 25}
            leftLabel="Introverted"
            rightLabel="Extraverted"
          />
          <DimensionSlider
            label="Information"
            percentage={p.sn === 'S' ? 25 : 75}
            leftLabel="Sensing"
            rightLabel="Intuition"
          />
          <DimensionSlider
            label="Decision-Making"
            percentage={p.tf === 'T' ? 25 : 75}
            leftLabel="Thinking"
            rightLabel="Feeling"
          />
          <DimensionSlider
            label="Planning"
            percentage={p.jp === 'J' ? 25 : 75}
            leftLabel="Judging"
        ...
        <p style={{ fontSize: '11pt', color: '#475569', lineHeight: 1.6 }}>
          Based on your responses, you {p.ei === 'E' ? 'draw energy from people and action' : 'draw energy from quiet, focused time'}, and you {p.jp === 'J' ? 'like structure and planning' : 'stay flexible and open-ended'}.
        </p>
      </div>
