...
export default function ResearchPage() {
  ...
  if (!ready) return <div style={styles.page}><p style={styles.muted}>Loading...</p></div>;
  ...
  return (
    <div style={styles.page}>
      <header style={styles.header} className="og-noprint">
        ...
        <div><span style={styles.email}>{user.email}</span>
          <button style={styles.backBtn} onClick={() => router.back()}>← Back</button></div>
      </header>
