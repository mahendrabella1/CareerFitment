...
export default function DashboardMobile({
  ...
  if (view === "report") {
    ...
    const isClass1112Journey = a.journeyCode === "11" || a.journeyCode === "12" || a.journeyCode === "11-12";
    ...
    const class6Ready = a.journeyCode === "6" && isCurrentClass6Shape(class6Output);
    const class7Ready = a.journeyCode === "7" && isCurrentClass7Shape(class7Output);
    const class8Ready = a.journeyCode === "8" && isCurrentClass8Shape(class8Output);
    const class678Stale =
      (a.journeyCode === "6" && !!class6Output && !class6Ready) ||
      (a.journeyCode === "7" && !!class7Output && !class7Ready) ||
      (a.journeyCode === "8" && !!class8Output && !class8Ready);

    let reportSummary = a;
    let reportExtraSheets: { id: string; kicker: string; node: ReactNode }[] = [];
    if (class11Ready) {
      reportSummary = adaptClass11ToSummary(class11Output, a);
      const c1112Category = a.journeyCode === "11" ? "class_11" : a.journeyCode === "12" ? "class_12" : "class_11_12";
      reportExtraSheets = [
      ...
      <div className="ogd-reportwrap">
        ...
        {class11Stale || class678Stale ? (
          <div style={{ maxWidth: 480, margin: "60px auto", textAlign: "center", padding: "0 20px" }}>
            ...
            <p style={{ fontSize: 13.5, color: "#63636f", lineHeight: 1.6, marginBottom: 20 }}>
