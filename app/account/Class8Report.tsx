      ...
      <div id="report-content" className="max-w-5xl mx-auto px-4 py-8 sm:px-6 lg:px-8 print:p-8 print:max-w-none print:bg-white">
        ...
        <section className="mb-8 print:page-break-inside-avoid">
          <div className="p-6 bg-purple-900/30 rounded-xl border border-slate-700/50 print:bg-gray-100 print:border-gray-300">
            <h2 className="text-2xl font-bold text-white print:text-black mb-2">Personality Preferences</h2>
            <p className="text-sm text-slate-300 print:text-gray-700 mb-6">
              Your four-letter MBTI-style code shows how you prefer to interact with the world.
            </p>

            <div className="text-center mb-6">
              <span className="inline-block text-3xl font-bold tracking-widest text-cyan-400 print:text-blue-700 bg-slate-700/30 print:bg-gray-50 px-6 py-3 rounded-lg">
                {output.personalityProfile.type}
              </span>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 bg-slate-700/30 rounded-lg print:bg-gray-50 print:border print:border-gray-300">
                <p className="text-xs font-semibold text-slate-400 print:text-gray-700 uppercase mb-1">Social Energy</p>
                <p className="text-sm font-semibold text-white print:text-black">
                  {output.personalityProfile.ei === "E"
                    ? "Energized by people (Extraversion)"
                    : "Energized by quiet time (Introversion)"}
                </p>
              </div>
              <div className="p-4 bg-slate-700/30 rounded-lg print:bg-gray-50 print:border print:border-gray-300">
                <p className="text-xs font-semibold text-slate-400 print:text-gray-700 uppercase mb-1">Information</p>
                <p className="text-sm font-semibold text-white print:text-black">
              ...
              <div className="p-4 bg-slate-700/30 rounded-lg print:bg-gray-50 print:border print:border-gray-300">
                <p className="text-xs font-semibold text-slate-400 print:text-gray-700 uppercase mb-1">Decision-Making</p>
                <p className="text-sm font-semibold text-white print:text-black">
                  {output.personalityProfile.tf === "T"
                    ? "Logic and fairness (Thinking)"
                    : "Values and empathy (Feeling)"}
                </p>
              </div>
              <div className="p-4 bg-slate-700/30 rounded-lg print:bg-gray-50 print:border print:border-gray-300">
                <p className="text-xs font-semibold text-slate-400 print:text-gray-700 uppercase mb-1">Planning</p>
                <p className="text-sm font-semibold text-white print:text-black">
                  {output.personalityProfile.jp === "J"
                    ? "Likes structure and plans (Judging)"
