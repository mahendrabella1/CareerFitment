    ...
    <section className="sheet">
      ...
      <div className="content-box">
        <div className="mbti-type-display">
          <span className="mbti-type-code">{output.layer1.personality.type}</span>
          <p className="mbti-type-caption">Your four-letter MBTI-style personality code</p>
        </div>
        ...
        <div className="trait-grid">
          <div className="trait-item">
            ...
            <p className="trait-value">
              {output.layer1.personality.ei === "E"
                ? "Energized by people and action (Extraversion)"
                : "Energized by quiet, focused time (Introversion)"}
            </p>
          </div>
          <div className="trait-item">
            <h4>Information</h4>
            <p className="trait-value">
              {output.layer1.personality.sn === "S"
                ? "Focus on facts and practical detail (Sensing)"
          ...
          <div className="trait-item">
            ...
            <p className="trait-value">
              {output.layer1.personality.tf === "T"
                ? "Logic and objective analysis (Thinking)"
                : "Values and impact on people (Feeling)"}
            </p>
          </div>
          <div className="trait-item">
            <h4>Planning</h4>
            <p className="trait-value">
              {output.layer1.personality.jp === "J"
                ? "Likes structure and plans (Judging)"
                : "Flexible and open-ended (Perceiving)"}
            </p>
          </div>
        </div>
