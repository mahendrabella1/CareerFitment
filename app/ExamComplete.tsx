...
.xc-actions{display:flex;gap:16px;margin:24px 0;align-items:center;justify-content:center}
@media(max-width:640px){.xc-actions{flex-direction:column;gap:12px}}

.xc-action-item{display:flex;align-items:center;justify-content:center}

.xc-cta{display:inline-flex;align-items:center;justify-content:center;gap:8px;padding:12px 24px;
  background:#171624;color:#fff;border:none;border-radius:10px;font-size:14px;font-weight:700;cursor:pointer;
  font-family:inherit;box-shadow:0 8px 18px rgba(23,22,36,.18);transition:background .15s;white-space:nowrap}
