...
import { scoreClass6Assessment, type Class6Response, type Class6ScoreOutput } from "@/lib/newAssessment/class6Scoring";
...
export default function Class6Assessment() {
  ...
  const submitAssessment = async () => {
    ...
    const response: Class6Response = {
      studentName: studentName.trim(),
      responses,
    };

    try {
      const scored = scoreClass6Assessment(response);
      setResults(scored);
      setPhase("results");
      ...
      const summary = {
        ...
        matches: [],
        topStrengths: [],
        class6Output: scored, // Store the full Class6 output
      };
