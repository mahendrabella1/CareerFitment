...
const S: Record<string, React.CSSProperties> = {
  ...
  qCard: { background: "#fff", border: `1px solid ${LINE}`, borderRadius: 16, padding: "32px 36px 24px", boxShadow: "0 2px 12px rgba(20,20,40,.05)" },
  qHead: { display: "flex", alignItems: "flex-start", gap: 14, marginBottom: 4 },
  qText: { flex: 1, fontSize: 21, fontWeight: 700, lineHeight: 1.55, color: INK },
  ...
  optList: { display: "flex", flexDirection: "column", borderTop: "1px solid #eef0f4", marginTop: 20 },
  optRow: { display: "flex", alignItems: "center", gap: 16, width: "100%", textAlign: "left", padding: "22px 20px", border: "1px solid transparent", borderBottom: "1px solid #eef0f4", cursor: "pointer", outline: "none" },
  ...
  radio: { flexShrink: 0, width: 22, height: 22, borderRadius: "50%", border: "2px solid #8d97a8", background: "#fff", display: "grid", placeItems: "center", boxSizing: "border-box" },
  radioOn: { borderColor: BLUE, boxShadow: `0 0 0 3px ${BLUE}1f` },
  radioDot: { width: 10, height: 10, borderRadius: "50%", background: BLUE },
  optLabel: { fontSize: 16.5, color: "#3a4356", lineHeight: 1.45 },
