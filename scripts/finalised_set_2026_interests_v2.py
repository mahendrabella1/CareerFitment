...
RAW = [
    ("Q1", "Your school is organizing a District-Level Community Fair. Which responsibility would you enjoy the most?", [
        ("INVESTIGATIVE", "Understanding the problem before suggesting a solution."),
        ("SYSTEMS", "Finding smarter ways to make things work better."),
        ("ETHICAL", "Making sure every decision is fair and well considered."),
        ("CREATIVE", "Communicating ideas that engage and inspire others."),
        ("PLANNING", "Planning and coordinating everything to stay on track."),
    ]),
    ("Q2", "You can spend a week shadowing anyone at work. What would you most want to watch them do?", [
        ("CREATIVE", "Shape a rough idea into something people actually notice."),
        ("PLANNING", "Keep a complicated operation running exactly to schedule."),
        ("INVESTIGATIVE", "Work out what is really going on before deciding anything."),
        ("SYSTEMS", "Take something that half works and make it work properly."),
        ("ETHICAL", "Weigh both sides of a difficult call and justify the decision."),
    ]),
    ("Q3", "Your town is setting up a new Model Village Project. Where would you want to be involved?", [
        ("SYSTEMS", "Designing how the whole thing should actually function."),
        ("ETHICAL", "Making sure the rules are fair to everyone affected."),
        ("PLANNING", "Turning the plan into a schedule and a budget that holds."),
        ("INVESTIGATIVE", "Finding out what the village actually needs, and why."),
        ("CREATIVE", "Telling the story so people want to be part of it."),
    ]),
    ("Q4", "For your Class 10 exhibition you can lead one project. Which appeals to you most?", [
        ("PLANNING", "One with many moving parts that must come together on time."),
        ("CREATIVE", "One that looks and feels like nothing else on show."),
        ("SYSTEMS", "One where I build something and keep improving how it works."),
        ("ETHICAL", "One that takes a contested issue and argues it properly."),
        ("INVESTIGATIVE", "One where I test an idea and find out whether it holds up."),
    ]),
    ("Q5", "You are given ₹10,000 for a student-led initiative. What would you put it into?", [
        ("ETHICAL", "Something that fixes an unfairness people have stopped noticing."),
        ("INVESTIGATIVE", "Finding out why a problem keeps coming back."),
        ("CREATIVE", "Something people will still remember long after it ends."),
        ("PLANNING", "Something that runs reliably every week without me."),
        ("SYSTEMS", "Building a tool that saves everyone time."),
    ]),
    ("Q6", "Which kind of story keeps you reading or watching the longest?", [
        ("INVESTIGATIVE", "How someone worked out the cause of something puzzling."),
        ("PLANNING", "How a huge undertaking was pulled off without falling apart."),
        ("ETHICAL", "How a difficult decision was argued over and finally settled."),
        ("SYSTEMS", "How something was built to do what nobody thought possible."),
        ("CREATIVE", "How an idea was made striking enough to change minds."),
    ]),
    ("Q7", "Something goes badly wrong on a school trip. What do you find yourself doing?", [
        ("SYSTEMS", "Fixing whatever has stopped working."),
        ("CREATIVE", "Getting a clear message out so nobody panics."),
        ("INVESTIGATIVE", "Working out what actually happened before anyone reacts."),
        ("ETHICAL", "Checking what we are responsible for and what the rules say."),
        ("PLANNING", "Getting people, supplies and transport organised."),
    ]),
    ("Q8", "Which problem would you be proudest to have solved twenty years from now?", [
        ("CREATIVE", "One where I changed how people see something."),
        ("ETHICAL", "One where I left a system fairer than I found it."),
        ("PLANNING", "One where I made something work at a scale nobody had managed."),
        ("SYSTEMS", "One where I made a thing dramatically better than it was."),
        ("INVESTIGATIVE", "One where I found the answer nobody else could find."),
    ]),
    ("Q9", "Picture your work ten years from now. What would make it a good day?", [
        ("PLANNING", "Everything I set up ran exactly as it should."),
        ("SYSTEMS", "I finally got a stubborn thing working."),
        ("CREATIVE", "I made something I was proud to show people."),
        ("INVESTIGATIVE", "I understood something that had been puzzling me for weeks."),
        ("ETHICAL", "I argued a difficult case and got it right."),
    ]),
    ("Q10", "You can add one extra subject next term, purely because you want to. What draws you?", [
        ("ETHICAL", "One that trains you to reason through hard, contested questions."),
        ("CREATIVE", "One that trains you to express an idea so that it lands."),
        ("INVESTIGATIVE", "One that trains you to test a claim properly."),
        ("PLANNING", "One that trains you to run something from end to end."),
        ("SYSTEMS", "One that trains you to design and build."),
    ]),
    ("Q11", "A company offers you a month with any one of its teams. Which do you ask for?", [
        ("INVESTIGATIVE", "The team working out why the product keeps failing."),
        ("SYSTEMS", "The team rebuilding how the product actually works."),
        ("PLANNING", "The team keeping costs, stock and delivery on track."),
        ("ETHICAL", "The team making sure it is safe and above board."),
        ("CREATIVE", "The team deciding how it should look and feel."),
    ]),
    ("Q12", "Your school starts a student magazine and website. Which job do you take?", [
        ("CREATIVE", "Deciding how it looks and how each story gets told."),
        ("INVESTIGATIVE", "Digging out the facts and checking that they hold up."),
        ("SYSTEMS", "Building the site and keeping it fast and working."),
        ("PLANNING", "Running the schedule, the budget and the ad slots."),
        ("ETHICAL", "Deciding what we should and should not publish."),
    ]),
]
